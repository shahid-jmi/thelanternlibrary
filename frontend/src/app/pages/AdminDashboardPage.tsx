...
import BooksPanel from '@/app/components/admin/BooksPanel';
import ProductsPanel from '@/app/components/admin/ProductsPanel';
import CategoriesPanel from '@/app/components/admin/CategoriesPanel';
