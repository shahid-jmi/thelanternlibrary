  ...
  return (
    <main id="home">
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 sm:px-6 md:py-20 lg:grid-cols-[45fr_55fr] lg:gap-16 lg:px-8">
        <Reveal>
          <ImageTile
            ...
            placeholder={
              <div className="flex flex-col items-center gap-6 text-[#e8d5a8]">
        ...
        <Reveal delay={120}>
          <div className="text-center lg:text-start">
            ...
            <div className="flex flex-wrap justify-center gap-4 lg:justify-start">
              <a
                href="#catalog"
                className="rounded-sm bg-ember px-8 py-3.5 text-xs uppercase tracking-[0.18em] text-ember-foreground transition hover:brightness-110"
              >
                Browse Catalog →
              </a>
              <a
                href="#contact"
                className="inline-flex items-center gap-2 rounded-sm border border-[var(--button-border)] px-8 py-3.5 text-xs uppercase tracking-[0.18em] transition hover:border-ember hover:text-ember"
              >
                <MessageCircle className="h-4 w-4" />
                Order Directly
              </a>
            </div>
            <p className="mt-14 text-[10px] uppercase tracking-[0.3em] opacity-55">
      ...
      <section id="offer" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-12 sm:px-6 lg:px-8">
        <Reveal>
          <p className="mb-3 text-center text-xs italic tracking-[0.2em] text-accent">i.</p>
          <h2 className="mb-4 text-center text-3xl tracking-[0.04em]">What We Offer</h2>
          ...
          {OFFERINGS.map((item, index) => (
            <Reveal key={item.name} delay={(index % 4) * 70}>
              <ImageTile
                ...
                placeholder={<item.icon className="h-10 w-10 text-[#c9913a]" strokeWidth={1.25} />}
                overlay={
                  <span className="absolute left-3 top-2 text-sm italic text-[#c9913a]">
                    {item.numeral}.
                  </span>
                }
              />
        ...
        <Reveal>
          <div className="grid overflow-hidden rounded-sm border border-border md:grid-cols-2">
            <div className="dark flex flex-col items-start gap-5 bg-background px-8 py-12 text-foreground sm:px-12">
              <p className="text-[10px] uppercase tracking-[0.3em] text-accent">The Shelves</p>
              <h3 className="text-3xl tracking-[0.04em]">Browse Our Library</h3>
              ...
              <a
                href="#catalog"
                className="mt-2 rounded-sm border border-[var(--button-border)] px-6 py-3 text-xs uppercase tracking-[0.18em] transition hover:border-accent hover:text-accent"
              >
                Enter the Library →
              </a>
            </div>
            <div className="flex flex-col items-start gap-5 bg-ember px-8 py-12 text-ember-foreground sm:px-12">
              <p className="text-[10px] uppercase tracking-[0.3em] opacity-80">The Cabinet</p>
              <h3 className="text-3xl tracking-[0.04em]">Explore Art &amp; Gifts</h3>
              ...
              <a
                href="#offer"
                className="mt-2 rounded-sm border border-ember-foreground/60 px-6 py-3 text-xs uppercase tracking-[0.18em] transition hover:bg-[rgba(0,0,0,0.12)]"
              >
                See the Collection →
              </a>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <Reveal>
          <div className="mb-10 flex items-end justify-between gap-4">
            <div>
              <p className="mb-3 text-xs italic tracking-[0.2em] text-accent">ii.</p>
              <h2 className="text-3xl tracking-[0.04em]">Featured Books</h2>
            </div>
            <div className="flex items-center gap-3">
              <a
                href="#catalog"
                className="hidden text-xs uppercase tracking-[0.18em] text-ember transition hover:opacity-75 sm:inline"
              >
                View all →
              </a>
              <button
      ...
      <section id="catalog" className="mx-auto scroll-mt-24 max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="mb-2 text-xs uppercase tracking-[0.28em] text-accent">
              iii. · The Shelves
            </p>
      ...
      <section className="dark mt-12 w-full border-y border-border bg-background py-20 text-foreground">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <Reveal>
            <p className="mb-3 text-xs italic tracking-[0.2em] text-accent">iv.</p>
            <h2 className="mb-6 text-4xl leading-tight tracking-[0.04em]">
            ...
            {MOSAIC.map((tile, index) => (
              <Reveal key={tile.label} delay={index * 80}>
                <ImageTile
                  ...
                  placeholder={
                    <div className="flex flex-col items-center gap-3 text-[#e8d5a8]">
                      <tile.icon className="h-8 w-8 text-[#c9913a]" strokeWidth={1.25} />
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <Reveal>
          <p className="mb-3 text-center text-xs italic tracking-[0.2em] text-accent">v.</p>
          <h2 className="mb-12 text-center text-3xl tracking-[0.04em]">From Our Readers</h2>
        </Reveal>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 text-center sm:px-6 lg:px-8">
        <Reveal>
          <p className="mb-3 text-xs italic tracking-[0.2em] text-accent">vi.</p>
      ...
      <section id="about" className="mx-auto scroll-mt-24 max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <Reveal>
          <p className="mb-3 text-center text-xs italic tracking-[0.2em] text-accent">vii.</p>
      ...
      >
        <Reveal>
          <p className="mb-3 text-center text-xs italic tracking-[0.2em] text-accent">viii.</p>
